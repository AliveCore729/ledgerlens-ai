...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var userA, userB, orgA, orgB, statementOrgA, targetId, currentUserId, statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Setting up test data...");
                    return [4 /*yield*/, prisma.user.create({ data: { email: 'userA@test.com', firstName: 'A' } })];
                case 1:
                    userA = _a.sent();
                ...
                case 4:
                    orgB = _a.sent();
                    return [4 /*yield*/, prisma.organizationUser.create({ data: { userId: userA.id, organizationId: orgA.id } })];
                case 5:
                    _a.sent();
                ...
                case 7:
                    ...
                    console.log("Created Statement ".concat(statementOrgA.id, " in Org A."));
                    console.log("Attempting to access Statement ".concat(statementOrgA.id, " as User B (Org B)..."));
                    targetId = statementOrgA.id;
                ...
                case 11:
                    _a.sent();
                    return [4 /*yield*/, prisma.user.delete({ where: { id: userA.id } })];
                case 12:
                    _a.sent();
